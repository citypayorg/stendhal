...
public class HouseBuyingTest extends ZonePlayerAndNPCTestImpl {
	...
	public void testGeneralStuff() {
		...
		assertEquals("I'm an estate agent. In simple terms, I sell houses for the city of Ados. Please ask about the #cost if you are interested. Our brochure is at #http://game.citypay.org/wiki/StendhalHouses.", getReply(npc));

		assertTrue(en.step(player, "offer"));
		assertEquals("I sell houses, please look at #http://game.citypay.org/wiki/StendhalHouses for examples of how they look inside. Then ask about the #cost when you are ready.", getReply(npc));

		assertTrue(en.step(player, "quest"));
		assertEquals("You may buy houses from me, please ask the #cost if you are interested. Perhaps you would first like to view our brochure, #http://game.citypay.org/wiki/StendhalHouses.", getReply(npc));
	}
