...
final class KirdnehHouseSeller extends HouseSellerNPCBase {
	...
	private void init() {
		...
		addJob("I'm an estate agent. In simple terms, I sell houses for the city of Kirdneh. Please ask about the #cost if you are interested. Our brochure is at #http://game.citypay.org/wiki/StendhalHouses.");
