...
abstract class HouseSellerNPCBase extends SpeakerNPC {
	...
	*/
	...
	private void createDialogNowWeKnowLocation() {
		...
		addReply(
				 "buy",
				 "You should really enquire the #cost before you ask to buy. And check our brochure, #http://game.citypay.org/wiki/StendhalHouses.");
		addReply("really",
				 "That's right, really, really, really. Really.");
		addOffer("I sell houses, please look at #http://game.citypay.org/wiki/StendhalHouses for examples of how they look inside. Then ask about the #cost when you are ready.");
		addHelp("You may be eligible to buy a house if there are any #available. If you can pay the #cost, I'll give you a key. As a house owner you can buy spare keys to give your friends. See #http://game.citypay.org/wiki/StendhalHouses for pictures inside the houses and more details.");
		addQuest("You may buy houses from me, please ask the #cost if you are interested. Perhaps you would first like to view our brochure, #http://game.citypay.org/wiki/StendhalHouses.");
		addGoodbye("Goodbye.");
	}
