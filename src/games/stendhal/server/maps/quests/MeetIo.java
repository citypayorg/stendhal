...
public class MeetIo extends AbstractQuest {
	...
	private void prepareIO() {
		...
		npc.add(
			...
			"Type #/support #<message> to report a problem. You can also try the IRC channel ##arianne on #'irc.freenode.net'. There is a web frontend at #http://game.citypay.org/development/chat.html \nOkay, time for your last lesson in mental manipulation!",
			null);
