...
public class StendhalRPRuleProcessor implements IRPRuleProcessor {
	...
	private static String welcomeMessage = "Welcome to Stendhal. Need help? #http://game.citypay.org/player-guide/ask-for-help.html - please report problems, suggestions and bugs. Remember to keep your password completely secret, never tell to another friend, player, or admin.";
