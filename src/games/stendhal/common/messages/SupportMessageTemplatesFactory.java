...
public class SupportMessageTemplatesFactory {
	...
	private void registerTemplates() {
		...
		addTemplate("$bugstracker","Hi %s, it sounds like you have found a new bug. Please could you create a bug report, details on how to do this are at #http://game.citypay.org/wiki/SubmitBug - thank you very much.");
		addTemplate("$bugreport","Hi %s, it sounds like you have found a new bug. Please could you create a bug report, details on how to do this are at #http://game.citypay.org/wiki/SubmitBug - thank you very much.");
		...
		addTemplate("$faqsocial", "Hi %s, sorry to hear about that. Please read #http://game.citypay.org/wiki/StendhalFAQ#Player_social_problems which covers some common problems.");
		...
		addTemplate("$notsupport","Hi %s, sorry, but support cannot help with this issue. Please use #https://stendhalgame.org and the wiki #http://game.citypay.org/wiki/Stendhal as information sources.");
		...
		addTemplate("$wiki","Hi %s, this is a question which is answered on the Stendhal wiki, please look on #http://game.citypay.org/wiki/Stendhal as this is full of useful information. Thanks for playing Stendhal.");
	}
